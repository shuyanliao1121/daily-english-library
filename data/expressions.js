const expressions = [
  ...
  [
    "An improvement in the aggregate does not necessarily benefit every group equally.",
    "#29"
  ],
  [
  ...
  [
    "Interests can be aligned without being identical.",
    "#27"
  ],
  [
    "When one thing becomes abundant, value often moves toward what remains scarce.",
    "#26"
  ]
];
